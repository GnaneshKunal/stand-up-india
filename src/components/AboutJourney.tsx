                ...
                <div className="row">
                    <div className="col-lg-12">
                            ...
                            <li>
                                ...
                                <div className="timeline-panel">
                                    ...
                                    <div className="timeline-body">
                                        <p className="text-muted">The Hon’ble Prime Minister, Shri. Narendra Modi in his Independence Day address
					    on August 15, 2015 unveiled his game changer campaign "Start-Up India" Stand-Up
					    India to promote entrepreneurship at grass root level for economic empowerment and
					    job creation. The Stand-Up India Scheme launched to coincide with the celebration
					    of the 125th birth anniversary of Dr. Babasaheb Bhimrao Ambedkar, seeks to leverage
					    the institutional credit structure to reach out to the underserved sector of people
					    such as Scheduled Caste, Scheduled Tribe and Women entrepreneurs so as to enable
					    them to participate in the economic growth of the nation. The scheme will benefit
					    atleast 2.5 lakh borrowers through 1.25 lakh bank branch network located across
					    the country.</p>
                                    </div>
                                </div>
                            </li>
                            <li className="timeline-inverted">
                                ...
                                <div className="timeline-panel">
                                    <div className="timeline-heading">
                                        <h4>2016</h4>
                                        <h4 className="subheading">Andhra Pradesh Chief Minister has cleared the relevant file</h4>
                                    </div>
                                    <div className="timeline-body">
                                        <p className="text-muted">“Chief Minister N. Chandrababu Naidu has cleared the relevant file,” he said while addressing a women empowerment programme..
				     ...
				     In the wake of protests that the Union government faces from Scheduled Castes and Scheduled Tribes communities, Kamble, who trained as a civil engineer and is an entrepreneur, said schemes such as Mudra and Stand up India have benefited the marginalised communities. </p>
                            ...
                            <li>
                                <div className="timeline-image">
                                    <img className="rounded-circle img-fluid" src="https://www.dropbox.com/s/1jyrmqxuvzfhlrw/pradyumna.jpg?raw=1" alt="" />
                                </div>
                                <div className="timeline-panel">
                                    <div className="timeline-heading">
                                        <h4>2018</h4>
