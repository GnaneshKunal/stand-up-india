...
class App {
    ...
    private mountRoutes(): void {
        ...
        router.get(['/', '/doc', '/search', '/success-stories', '/meetings', '/upload', '/success-submit', '/loan-sanctioned', '/success-list', '/success-doc', '/download-app', '/downloads'], (_, res: express.Response) => {
